...
### Z-Score: Definition, Calculation, and Applications
...
:::warning[Standardization vs Normalization]
...
Standardization transforms data to have a mean of $0$ and a standard deviation of $1$. This is what we just discussed with Z-scores.

$$
z = \frac{x - μ}{σ}
$$

- Doesn't bound data within a specific range
- Preserves outliers (though reduces their impact)
- Results in both positive and negative values
- Particularly useful for algorithms that assume data is normally distributed (like SVMs, linear/logistic regression)
...
- Bounds data within a specific range
- More sensitive to outliers
- Useful when you need bounded values (like in neural networks with sigmoid activation)
- Preserves the distribution shape but squeezes it into a smaller range
